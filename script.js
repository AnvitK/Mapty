...
// const run1 = new Running([39, -12], 5.5, 28, 185);
// const cycling1 = new Cycling([39, -12], 25, 85, 510);
...
class App {
    ...
    _loadMap(position) {
        ...
        // on clicking on map render the form by removing hidden class
    ...
    _hideForm() {
        ...
        setTimeout(() => {
            form.style.display='';
            // if(screen.width < 1300) form.style.display = 'flex';
    ...
    _newWorkout(e) {
        ...
        // If workout activity is running, create running object
        if(type === 'running' ) {
        ...
        // If workout activity is cycling, create cycling object
        if(type === 'cycling' ) {
        ...
        // Render the workout on map as worker
        this._renderWorkoutMarker(workout);

        // Render the workout on sidebar list 
